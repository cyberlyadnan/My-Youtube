...
const SideBarIcons = () => {
  return (
    <div className=' bg-white shadow-lg p-2 h-[800PX]'>
      <div className='mb-6'>
        <ul>
          <li className='mb-4 text-2xl py-4 px-4 hover:rounded-lg rounded-lg cursor-pointer hover:bg-gray-100'><FontAwesomeIcon icon={faHome} className='text-gray-700 hover:text-black' /></li>
